...
Ο κώδικας της εργασίας υλοποιήθηκε στο περιβάλλον Google Colab.

\begin{itemize}
    \item Initialization of dataset, displaying dataset information
    \item initialization of seeds
    \item Training, validation, test split. Batches. Normalized versions.
\end{itemize}
