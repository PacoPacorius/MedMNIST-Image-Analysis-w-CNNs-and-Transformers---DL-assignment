...
Στο πρώτο μέρος της εργασίας ορίζουμε ένα Συνελκτικό Νευρωνικό Δίκτυο (CNN) από την αρχή. Η 
αρχιτεκτονική του έχει ως εξής. Αποτελείται από 3 συνελικτικά blocks, ένα dropout layer και
...
στο ότι, αν έιχαμε $padding=0$, σύμφωνα με τον τύπο.
